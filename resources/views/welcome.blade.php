...
<body>
<header style="width:100%;border:1px solid black;text-align: center;padding:2%;" class="bg-dark text-light">
    <h4>Welcome to the Super Blog.</h4>
</header>
...
<div style="width: 70%;margin-left: 15%;margin:2%;" class="alert alert-success">To see all posts by a particular author, click on the author's name.</div>
<div style="width: 70%;margin-left: 15%;margin:2%;" class="alert alert-danger">Designed and managed by Jonathan Baraza.</div>
</center>
<center>
    <a href="{{route('register')}}" class="btn btn-outline-info p-3">GET STARTED</a>
</center>
</body>
</html>