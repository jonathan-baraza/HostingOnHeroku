...
@endif
<center>
	<div class="alert alert-success">These are {{$user->username}}'s posts <b>({{$user->posts->count()}})</b>.</div>
</center>
<main>
	...
	<div style="width: 50%;margin-left: 25%;display: flex;justify-content: center;">
